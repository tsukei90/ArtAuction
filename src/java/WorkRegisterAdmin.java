...
public class WorkRegisterAdmin extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ("jdbc:oracle:thin:@localhost:1521:ORCL","scott","scott");
                ...
                ops = (OraclePreparedStatement) 
                        oconn.prepareCall
        ("INSERT INTO auctioneers(EMAIL, USERNAME, NAME, PASSWORD) values(?,?,?,?)");
    ...
    if (ex instanceof SQLIntegrityConstraintViolationException) {
        ...
        response.sendRedirect("Admin/Register.html?message=This%20username%20is%20already%20in%20use.%20Please%20choose%20a%20different%20one.");
