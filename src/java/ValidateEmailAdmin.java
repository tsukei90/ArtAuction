...
public class ValidateEmailAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM auctioneers where email=?");
            ...
            {
                vto=vemail;
                vsubject="Reset Your Auctionner Password";
                vbody="Click the link to reset your Auctioneer password ";
            ...
            try {
                    ...
                    vbody = "Click the link to reset your Auctioneer password\n";
                    vbody += "http://localhost:8080/WebApplication_TEST/Admin/AdminForgotPass/VerifyQues.jsp?pemail=" + vemail;
                    message.setText(vbody);
                    Transport.send(message);
                    response.sendRedirect("http://localhost:8080/WebApplication_TEST/Admin/AdminForgotPass/ForgotClose.html");
            ...
            {
                response.sendRedirect("Admin/AdminForgotPass/WrongEmail.html");
            }
            ost.close();
            oconn.close();
            out.println("</body>");
